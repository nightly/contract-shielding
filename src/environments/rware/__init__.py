...
from .impl.warehouse import RewardType, ObservationType
from .impl.pettingzoo_env import env as pettingzoo_env, parallel_env
...
for size, diff, agents in _perms:
    ...
    register(
        ...
        entry_point="src.environments.rware.impl.warehouse:Warehouse",
        kwargs={
            "column_height": 8,
